            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  id="remember"
                  type="checkbox"
                  className="h-4 w-4 text-almarai-green focus:ring-almarai-green border-gray-300 rounded"
                />
              ...
              <Link
                ...
                className="text-sm text-almarai-green hover:text-almarai-green-dark"
              >
                Forgot password?
              </Link>
            </div>
